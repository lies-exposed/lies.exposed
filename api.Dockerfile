...
COPY --from=build /usr/src/app/packages/@liexp/test/lib /prod/packages/@liexp/test/lib
COPY --from=build /usr/src/app/packages/@liexp/test/package.json /prod/packages/@liexp/test/package.json
