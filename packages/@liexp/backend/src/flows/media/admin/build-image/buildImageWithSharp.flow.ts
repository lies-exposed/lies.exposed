...
type AddLayerFlow = <
  C extends ImgProcClientContext &
    LoggerContext &
    HTTPProviderContext &
    ConfigContext,
>(
  layer: BuildImageLayer,
  opts: SharpOverlayOptionsWithSize | undefined,
) => ReaderTaskEither<C, ImgProcError, SharpOverlayOptionsWithSize[]>;

const addLayer: AddLayerFlow = <
  C extends ImgProcClientContext &
    LoggerContext &
    HTTPProviderContext &
    ConfigContext,
...
const addWatermarkLayer =
  <
    C extends LoggerContext &
      ImgProcClientContext & { config: Record<string, any> },
  >(
...
export const buildImageWithSharp =
  <
    C extends LoggerContext &
