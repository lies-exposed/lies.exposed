      ...
      pipe(
        {
          ...
          actor,
          relatedActor,
          startDate: actorRelation.startDate?.toISOString() ?? undefined,
          endDate: actorRelation.endDate?.toISOString() ?? undefined,
          createdAt: actorRelation.createdAt.toISOString(),
          updatedAt: actorRelation.updatedAt.toISOString(),
          deletedAt: actorRelation.deletedAt?.toISOString() ?? undefined,
        },
        Schema.decodeEither(io.http.ActorRelation.ActorRelation),
        E.mapLeft((e) =>
          DecodeError.of(
