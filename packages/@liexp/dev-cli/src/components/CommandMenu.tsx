...
const ITEMS: MenuItem[] = [
  ...
  { label: "upgrade",     value: "upgrade",     description: "Helm upgrade only (no pod restart)", tab: "k8s"    },
  { label: "release",     value: "release",     description: "Helm upgrade + rollout restart",     tab: "k8s"    },
