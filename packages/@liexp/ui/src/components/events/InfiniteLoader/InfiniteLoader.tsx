...
export interface EventsInfiniteLoaderProps
  ...
  List: React.ForwardRefExoticComponent<
    EventsTimelineListProps & React.RefAttributes<unknown>
  >;
}

export const EventsInfiniteLoader: React.FC<EventsInfiniteLoaderProps> = (
  props,
) => {
  const { hash, queryParams, List, ...listProps } = props;
  const api = useAPI();
