...
export const CreateMedia = Schema.Struct({
  ...
  thumbnail: Schema.UndefinedOr(URL),
  extra: Schema.UndefinedOr(MediaExtra),
  type: MediaType,
...
export const EditMediaBody = Schema.Struct({
  type: MediaType,
  thumbnail: Schema.OptionFromUndefinedOr(Schema.NullOr(URL)),
  location: URL,
  label: Schema.String,
  description: Schema.OptionFromUndefinedOr(Schema.NullOr(Schema.String)),
  extra: Schema.OptionFromUndefinedOr(Schema.NullOr(MediaExtra)),
  links: Schema.Array(UUID),
  events: Schema.Array(UUID),
  keywords: Schema.Array(UUID),
  areas: Schema.Array(UUID),
  ...
  overrideExtra: Schema.OptionFromUndefinedOr(Schema.Boolean),
  transfer: Schema.OptionFromUndefinedOr(Schema.Boolean),
  transferThumbnail: Schema.OptionFromUndefinedOr(Schema.Boolean),
