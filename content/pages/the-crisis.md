...
<full-size-section id="aria" backgroundColor="white">
...
![Ciclo del carbonio](../../static/media/img/ciclo-carbonio.jpg)

(![pie-chart](https://vx-demo.now.sh/pies) chart assorbimento CO2 di oceani, foreste, animali, ecc)

</full-size-section>

<full-size-section id="concentrazione-co2-1000-anni">
...
<full-size-section id="sesta-estinzione-di-massa">
...
Il nostro "business as usual" è destinato a generare un fase di tracollo dove la popolazione avrà toccato il suo apice in termini di quantità ma il cibo inizierà a scarseggiare per le risorse sempre più scarse.
...
<full-size-section id="antropocene">

## Antropocentrismo

<img width="300" src="../../static/media/img/ego-pyramid.jpg" alt="Ego Pyramid"></img>

L'**Antropocentrismo** è la tendenza a considerare l'*Homo Sapiense* al centro dell'Universo.
