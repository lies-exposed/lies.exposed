...
export class migrations1671648075880 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."event_v2_type_enum" AS ENUM('Death', 'ScientificStudy', 'Uncategorized', 'Patent', 'Documentary', 'Transaction', 'Quote')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."event_v2_type_enum_old" AS ENUM('Death', 'ScientificStudy', 'Uncategorized', 'Patent', 'Documentary', 'Transaction')`);
        await queryRunner.query(`ALTER TABLE "event_v2" ALTER COLUMN "type" DROP DEFAULT`);
