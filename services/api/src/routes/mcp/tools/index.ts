...
// import { registerActorTools } from "./actors/actor.tools.js"; // disabled — actor ops handled by agent CLI tool
...
export const registerTools = (server: McpServer, ctx: ServerContext) => {
  // registerActorTools(server, ctx); // disabled — actor ops handled by agent CLI tool
