...
const EventTemplate: React.FC<EventTemplatePageProps> = ({ data }) => {
  ...
  return pipe(
    Events.EventMD.decode(data.pageContent.childMdx),
    E.filterOrElse(Events.Uncategorized.UncategorizedMD.is, (value): t.Errors => [
      {
        value,
        context: [t.getContextEntry("event", Events.Uncategorized.UncategorizedMD)],
      },
    ]),
