...
export const eventCreate: CommandModule = {
  help: `
Usage: agent event create [options]

Create a new event. The --type flag determines which payload fields are required.

Common options:
  --type=<string>              Event type (required): Uncategorized | Death | Quote |
                               Transaction | ScientificStudy | Book | Patent | Documentary
  --date=<YYYY-MM-DD>          Event date (required)
  --draft=<true|false>         Draft flag (default: false)
  --excerpt=<string>           Short excerpt text
  ...
  run: (ctx, args) =>
    runCommand(
      ...
      CreateEventInputSchema,
      {
        ...
        groupsMembers: splitUUIDs(getArg(args, "groupsMembers")),
        location: getArg(args, "location"),
        endDate: getArg(args, "endDate"),
        victim: getArg(args, "victim"),
        actor: getArg(args, "actor"),
        quote: getArg(args, "quote"),
        details: getArg(args, "details"),
        total: getArg(args, "total"),
        currency: getArg(args, "currency"),
        fromType: getArg(args, "fromType"),
        fromId: getArg(args, "fromId"),
        toType: getArg(args, "toType"),
        toId: getArg(args, "toId"),
        studyUrl: getArg(args, "studyUrl"),
        image: getArg(args, "image"),
        publisher: getArg(args, "publisher"),
        authors: getArg(args, "authors"),
        pdf: getArg(args, "pdf"),
        audio: getArg(args, "audio"),
        ownerActors: getArg(args, "ownerActors"),
        ownerGroups: getArg(args, "ownerGroups"),
        source: getArg(args, "source"),
        documentaryMedia: getArg(args, "documentaryMedia"),
        website: getArg(args, "website"),
        authorActors: getArg(args, "authorActors"),
